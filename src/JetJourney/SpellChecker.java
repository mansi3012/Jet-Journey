...
public class SpellChecker {
    ...
    // The constructor initializes the dictionary by reading words from a file
    // (cities.txt) and adding them to the HashSet.
    public SpellChecker() throws FileNotFoundException {
        dictionary = new HashSet<>(); // Initialize the HashSet
        Scanner sc = new Scanner(
                new File(JetJourney.SRC_FOLDER_PATH + "cities.txt"));
        while (sc.hasNext()) {
    ...
    // This method suggests corrections for a misspelled word by calculating the
    // edit distance between the misspelled word and each word in the dictionary.
    ...
    // This method calculates the edit distance between two strings using dynamic
    // programming.
    ...
    // If the word is not in the dictionary, it suggests corrections based on the
    // edit distance.

    public static boolean checkandSuggestWords(String w) throws FileNotFoundException {
